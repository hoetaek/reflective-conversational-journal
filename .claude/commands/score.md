...
---
*10년 후의 당신도 이 피드백을 보고 성장의 흔적을 느낄 수 있을 거예요.*
"""
...
if __name__ == "__main__":
    ...
    print("궁금한 게 있어요 - 오늘 저널 어떻게 작성했는지 살펴볼까요?")
    ...
    print(f"저널 평가가 완료되었습니다. 종합 점수: {overall_score}점")
    print("성장을 위한 피드백이 저널 파일에 추가되었어요!")
```
