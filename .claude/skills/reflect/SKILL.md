...
name: reflect
description: |
  자유 노트를 성찰로 정리. AI가 성찰할 만한 내용을 감지하면 자동 실행.
...
자유 노트와 대화 내용을 스캔하여 트리거 조건에 해당하는 항목을 식별한다.
...
1. **자유 노트에 내용이 있는데** 성찰이 비어있거나 플레이스홀더인 경우
2. 자유 노트에도 내용이 없으면 → 성찰 대상 없음, 스킵

### 제안 방식

- 가벼운 질문 1개로 유도: "오전에 ~했는데, 뭔가 느낀 거 있어?"
- 자유 노트의 내용을 구체적으로 언급해서 회상을 도와줌
