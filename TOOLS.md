...
| weekly | `.claude/skills/weekly/` | 주간 회고 생성 |
| profile | `.claude/skills/profile/` | 프로필.md 생성/수정 |
...
| 훅 | 실행 시점 | 역할 |
|----|----------|------|
| `load-profile-journals.js` | SessionStart | 프로필, 최근 저널, 계획을 XML로 로드 |
